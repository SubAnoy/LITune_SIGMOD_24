...
if __name__ == "__main__":
    ...
    if args.search_method == "BO":
        ...
        if args.Index == "PGM":
            ...
            'external_kMinOutOfDomainKeys':hp.choice('external_kMinOutOfDomainKeys',range(2,500,1)),
            ...
            'kAlgorithmThreshold':hp.choice('kAlgorithmThreshold',range(1,300000)),
        ...
        best = fmin(f_model, param_grid, algo=tpe.suggest, max_evals=MAX_EVALS, trials=trials)
        end = time.monotonic()
    ...
    if args.search_method == "heuristic_search":
        ...
        if args.Index == "PGM":
            ...
            'kAlgorithmThreshold':list(range(1,300000)),
        ...
        def model_loss(params):
            ...
            # other Index in progress 
                ...
                os.system('g++ ./Index/Alex/index_test.cpp -w -std=c++17 -msse4 -mpopcnt -mlzcnt -mbmi -o ./Index/Alex/exe_alex_index')
                cmd = f'./Index/Alex/exe_alex_index ./data_SOSD/{data_file_name} {query_type}'
                # cmd = ['./Index/Alex/exe_alex_index', f'./data_SOSD/{data_file_name}', f'{query_type}']
    ...
    if args.search_method == "grid_search":
        ...
        if args.Index == "PGM":
            ...
            'external_splittingPolicyMethod':[0],
            'external_allowSplittingUpwards':[0],
            'external_kMinOutOfDomainKeys':list(range(2,500,100)),
