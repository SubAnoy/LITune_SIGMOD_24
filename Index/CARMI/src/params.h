 ...
 */
static constexpr int kMaxLeafNodeSize = external_kMaxLeafNodeSize;
 ...
 */
static constexpr int kMaxLeafNodeSizeExternal = external_kMaxLeafNodeSizeExternal;
 ...
 * (25.4 ns).
 */
static constexpr double kLeafBaseTime = external_kLeafBaseTime;

/**
 * @brief The average time cost of a binary search
 */
static constexpr double kCostBSTime = external_kCostBSTime;
}  // namespace carmi_params
