...
inline void CARMI<KeyType, ValueType, Compare, Alloc>::ConstructSubTree(
  ...
  //ADDED STATS
  stats_remainingNode = remainingNode;
  stats_remainingRange = remainingRange;
...
inline void CARMI<KeyType, ValueType, Compare, Alloc>::Construction() {
  ...
  //ADDED STATS
  stats_initDataset = initDataset;
  stats_findQuery = findQuery;
  stats_insertQuery = insertQuery;
