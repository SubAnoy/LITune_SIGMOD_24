...
//  private: //ADDED: Changed to access states
 public:
...
public:
    DataVectorType stats_initDataset;
    QueryType stats_findQuery;
    KeyVectorType stats_insertQuery;
    std::map<IndexPair, NodeCost> stats_COST;
    std::vector<int> stats_remainingNode;
    std::vector<DataRange> stats_remainingRange;
