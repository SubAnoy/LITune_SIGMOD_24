...
class AlexDataNode : public AlexNode<T, P> {
 public:
  ...
  static constexpr double kMaxDensity_ = external_kMaxDensity; //0.8;  // density after contracting,
                                               // also determines the expansion
                                               // threshold
  static constexpr double kInitDensity_ =
      external_kInitDensity;  //0.7; // density of data nodes after bulk loading
  static constexpr double kMinDensity_ = external_kMinDensity;  //0.6; // density after expanding, also
  ...
  static constexpr int kDefaultMaxDataNodeBytes_ =
      external_maxNodeSize; //1 << 24;  // by default, maximum data node size is 16MB
  ...
  // appends
  static constexpr double kAppendMostlyThreshold =  external_kAppendMostlyThreshold; //0.9;
